# Advertiser document authenticity

Research and design for verifying business documents that advertisers upload to prove registration, licensing, or affiliation with another company (US scope, affiliation proofs first).

- `docs/DESIGN.md`: findings, stress test of the "authentic or not" framing, architecture, playbooks per document type, evaluation plan, two-week build plan, open decisions.
- `docs/research/01-google-ads-policy-and-fraud-patterns.md`: what Google Ads accepts, documented abuse, what platforms say they do, dealer-locator probes.
...
- `docs/research/06-competitive-landscape.md`: who already does this, by method, with evidence of success and what each does not do.
